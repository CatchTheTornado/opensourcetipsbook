...
In [Chapter 5](./chapter5-investing-in-opensource) you learned about different ways of commercializing Open Source projects. While these models differentiate a lot between each other the path to commercialization almost always looks the same way.
