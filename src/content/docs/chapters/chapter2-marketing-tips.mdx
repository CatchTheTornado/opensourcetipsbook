...
A key factor in the success of Vue Storefront was our steadfast decision to create genuine open-source software. It didn't start with a direct business model backing it. Actually the first commercial model in the very early days were services. We came after PaaS offering and commercial license along the way, carefully listening to customers feedback. You might think: isn't that just PR or marketing?
